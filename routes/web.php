...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin'], function () {
    ...
    //Route crawl ophim
    Route::controller(CrawlOphimController::class)->prefix('ophim')->group(function () {
        Route::get('crawlphim',  'crawlophimcc')->name('crawlophim.index');
        Route::post('check_nguon', 'check_nguon')->name('crawlophim.check');
        Route::post('crawl_by_id', 'crawl_by_id')->name('crawlophim.crawl_one');
        Route::post('crawl_page', 'crawl_page')->name('crawlophim.crawl_page');
        Route::post('get_movies_page', 'get_movies_page')->name('crawlophim.get_movies_page');
    });

    //Route crawl nguontv
    Route::controller(CrawlNguonController::class)->prefix('nguon')->group(function () {
        Route::get('crawlphim',  'crawlnguon')->name('crawlnguon.index');
...
Route::get('/debug', function() {
    $a = DateTime::createFromFormat('Y-m-d\TH:i:s.vp', '2023-02-25T14:01:33.000Z')->format('d');
    // $a = date('Y-m-d\TH:i:s.vp', time());
    dd($a);
});
