        ...
        <div id="sidebar-menu">
            ...
            @if (Auth::User()->usertype == 'Admin')
                <ul>
                    ...
                    {{-- CrawlOphim --}}
                        <li><a href="{{ route('crawlophim.index') }}"
                            class="waves-effect {{ classActivePath('ophim') }}"><i
                                class="fa fa-database"></i><span>{{ "Crawl Ophim" }}</span></a>
                        </li>

                    {{-- CrawlNguonTv --}}
                        <li><a href="{{ route('crawlnguon.index') }}"
                            class="waves-effect {{ classActivePath('nguon') }}"><i
                                class="fa fa-play"></i><span>{{ "Crawl NguonTV" }}</span></a>
                        </li>
                @else
                    <ul>
                        <li><a href="{{ URL::to('admin/dashboard') }}"
